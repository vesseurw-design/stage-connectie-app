...
1.  Vertrouwelijke Informatie: De gebruiker erkent dat de Applicatie persoonsgegevens van minderjarige leerlingen bevat. Alle gegevens in de Applicatie worden beschouwd als strikt vertrouwelijk.
2.  Geheimhoudingsplicht: De gebruiker verplicht zich tot geheimhouding van alle persoonsgegevens en bedrijfsinformatie waarvan hij/zij via de Applicatie kennisneemt.
3.  Delen van gegevens: Het is niet toegestaan om gegevens uit de Applicatie (zoals namen van leerlingen, aanwezigheidslijsten of contactgegevens) te exporteren, printen of door te sturen aan derden, tenzij dit strikt noodzakelijk is voor de taakuitoefening in het kader van de stagebegeleiding.

--------------------------------------------------------------------------------

4. BEWAARTERMIJNEN VAN GEGEVENS
Conform de Algemene Verordening Gegevensbescherming (AVG) worden gegevens niet langer bewaard dan noodzakelijk:

1.  Stagegegevens (Aanwezigheid/Beoordeling): Deze gegevens worden bewaard totdat de leerling is uitgeschreven bij de onderwijsinstelling, plus een bewaartermijn van één (1) jaar daarna. Na deze periode worden de gegevens automatisch verwijderd of volledig geanonimiseerd voor statistische doeleinden.
2.  Accountgegevens (Werkgevers/Begeleiders): Accounts van stagebegeleiders die langer dan twee (2) jaar inactief zijn, worden gedeactiveerd en verwijderd, tenzij er een actieve stagekoppeling is.
3.  Verwijderverzoek: Gebruikers kunnen te allen tijde een verzoek indienen bij De Eigenaar om hun eigen persoonsgegevens te laten verwijderen, mits dit niet strijdig is met de wettelijke bewaarplicht van de betrokken onderwijsinstelling.

--------------------------------------------------------------------------------

5. BEVEILIGING
1.  Zorgvuldigheid: De gebruiker draagt zorg voor een veilig gebruik van de apparatuur waarmee ingelogd wordt (bijv. scherm vergrendelen bij weglopen).
...
Copyright 2026 Willemien Vesseur - StageConnectie
